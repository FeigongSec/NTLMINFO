...
namespace SharpRDPCheck
{
    internal class MCS
    {
        ...
        internal static byte[] RDPNTLMSSPNegotiate(byte[] loadBalanceToken, bool bAutoReconnect)
        {
            int num;
            ...
            try
            {
                ...
                return CredSSP.GetRDPNTLMSSPNegotiate();
            ...
            {
                Console.WriteLine($@"target {Options.Host} RDP Auth Fail: {exception.Message}");
                throw;
            }
